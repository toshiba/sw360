...
===== Links
include::{snippets}/should_document_create_license/links.adoc[]
...
[[resources-update-external-link-license]]
==== Update external link a license

A `PATCH` request will update external link license.

===== Response structure
include::{snippets}/should_document_update_external_link_license/response-fields.adoc[]

===== Example request
include::{snippets}/should_document_update_external_link_license/curl-request.adoc[]

===== Example response
include::{snippets}/should_document_update_external_link_license/http-response.adoc[]
