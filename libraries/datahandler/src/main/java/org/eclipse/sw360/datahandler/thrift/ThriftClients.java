...
public class ThriftClients {
    ...
    private static final String SW360_CONFIG_SERVICE_URL = "/configuration/thrift";
    ...
    public SW360ConfigService.Iface makeSW360ConfigClient() {
        return new SW360ConfigService.Client(makeProtocol(BACKEND_URL, SW360_CONFIG_SERVICE_URL));
    }
}
